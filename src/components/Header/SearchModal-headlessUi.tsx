        ...
        <>
            <Transition appear as={Fragment} show={modalOpen}>
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                        ...
                        <div className="fixed inset-0 z-50 overflow-y-auto flex items-start top-[6.6rem] mb-4 justify-center transform px-4 sm:px-6">
                            <Transition.Child
                                as={Fragment}
                                enter="ease-out duration-300"
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden text-left rounded-md align-middle transition-all">
                                    <div ref={modalContent} className="bg-white overflow-auto max-w-2xl w-full max-h-full shadow-lg">
                                        {/* Search form */}
                                        <form className="border-b border-slate-200 sticky top-0">
